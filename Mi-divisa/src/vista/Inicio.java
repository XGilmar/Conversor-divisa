...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblLinkedin1 = new javax.swing.JLabel();
        lblDerechos1 = new javax.swing.JLabel();
        lblDerechos3 = new javax.swing.JLabel();
        Tiempo = new javax.swing.JPanel();
        jLabel7 = new javax.swing.JLabel();
        lblGithub2 = new javax.swing.JLabel();
        lblLinkedin2 = new javax.swing.JLabel();
        lblDerechos4 = new javax.swing.JLabel();
        lblDerechos5 = new javax.swing.JLabel();
        ...
        jLabel5.setBounds(65, 15, 123, 14);
        ...
        lblConvertir.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/open (5).png"))); // NOI18N
        Temperatura.add(jLabel3);
        jLabel3.setBounds(80, 80, 140, 140);

        lblGithub.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/GitHub.png"))); // NOI18N
        ...
        Temperatura.add(lblGithub);
        lblGithub.setBounds(111, 341, 35, 35);

        lblLinkedin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Linkedin.png"))); // NOI18N
        ...
        Temperatura.add(lblLinkedin);
        lblLinkedin.setBounds(156, 341, 34, 35);

        lblDerechos.setBackground(new java.awt.Color(255, 255, 255));
        lblDerechos.setFont(new java.awt.Font("Poppins", 0, 11)); // NOI18N
        lblDerechos.setForeground(new java.awt.Color(51, 51, 51));
        lblDerechos.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblDerechos.setText("© Copyright Gilmar Escudero");
        Temperatura.add(lblDerechos);
        lblDerechos.setBounds(43, 377, 219, 18);

        lblDerechos2.setFont(new java.awt.Font("Poppins", 0, 11)); // NOI18N
        lblDerechos2.setForeground(new java.awt.Color(51, 51, 51));
        lblDerechos2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblDerechos2.setText("2023");
        Temperatura.add(lblDerechos2);
        lblDerechos2.setBounds(43, 396, 219, 18);

        materialTabbed1.addTab("Temperatura", Temperatura);

        Masa.setBackground(new java.awt.Color(255, 255, 255));
        Masa.setLayout(null);

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/open (5).png"))); // NOI18N
        Masa.add(jLabel6);
        jLabel6.setBounds(80, 80, 140, 140);

        lblGithub1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/GitHub.png"))); // NOI18N
        lblGithub1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblGithub1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblGithub1MouseClicked(evt);
            }
        });
        Masa.add(lblGithub1);
        lblGithub1.setBounds(111, 341, 35, 35);

        lblLinkedin1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Linkedin.png"))); // NOI18N
        lblLinkedin1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblLinkedin1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblLinkedin1MouseClicked(evt);
            }
        });
        Masa.add(lblLinkedin1);
        lblLinkedin1.setBounds(156, 341, 34, 35);

        lblDerechos1.setBackground(new java.awt.Color(255, 255, 255));
        lblDerechos1.setFont(new java.awt.Font("Poppins", 0, 11)); // NOI18N
        lblDerechos1.setForeground(new java.awt.Color(51, 51, 51));
        lblDerechos1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblDerechos1.setText("© Copyright Gilmar Escudero");
        Masa.add(lblDerechos1);
        lblDerechos1.setBounds(43, 377, 219, 18);

        lblDerechos3.setFont(new java.awt.Font("Poppins", 0, 11)); // NOI18N
        lblDerechos3.setForeground(new java.awt.Color(51, 51, 51));
        lblDerechos3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblDerechos3.setText("2023");
        Masa.add(lblDerechos3);
        lblDerechos3.setBounds(43, 396, 219, 18);

        materialTabbed1.addTab("Masa", Masa);

        Tiempo.setBackground(new java.awt.Color(255, 255, 255));
        Tiempo.setLayout(null);

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/open (5).png"))); // NOI18N
        Tiempo.add(jLabel7);
        jLabel7.setBounds(80, 80, 140, 140);

        lblGithub2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/GitHub.png"))); // NOI18N
        ...
        Tiempo.add(lblGithub2);
        lblGithub2.setBounds(111, 341, 35, 35);

        lblLinkedin2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Linkedin.png"))); // NOI18N
        lblLinkedin2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lblLinkedin2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblLinkedin2MouseClicked(evt);
            }
        });
        Tiempo.add(lblLinkedin2);
        lblLinkedin2.setBounds(156, 341, 34, 35);

        lblDerechos4.setBackground(new java.awt.Color(255, 255, 255));
        lblDerechos4.setFont(new java.awt.Font("Poppins", 0, 11)); // NOI18N
        lblDerechos4.setForeground(new java.awt.Color(51, 51, 51));
        lblDerechos4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblDerechos4.setText("© Copyright Gilmar Escudero");
        Tiempo.add(lblDerechos4);
        lblDerechos4.setBounds(43, 377, 219, 18);

        lblDerechos5.setFont(new java.awt.Font("Poppins", 0, 11)); // NOI18N
        lblDerechos5.setForeground(new java.awt.Color(51, 51, 51));
        lblDerechos5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblDerechos5.setText("2023");
        Tiempo.add(lblDerechos5);
        lblDerechos5.setBounds(43, 396, 219, 18);

        materialTabbed1.addTab("Tiempo", Tiempo);
    ...
    private void lblGithub1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblGithub1MouseClicked
        miUrl.MiDireccion("https://github.com/XGilmar");
    }//GEN-LAST:event_lblGithub1MouseClicked

    private void lblLinkedin1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLinkedin1MouseClicked
        miUrl.MiDireccion("https://www.linkedin.com/in/gilmarescudero/");
    }//GEN-LAST:event_lblLinkedin1MouseClicked
    ...
    private void lblLinkedin2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLinkedin2MouseClicked
        miUrl.MiDireccion("https://www.linkedin.com/in/gilmarescudero/");
    }//GEN-LAST:event_lblLinkedin2MouseClicked
    ...
    private javax.swing.JLabel lblDerechos3;
    private javax.swing.JLabel lblDerechos4;
    private javax.swing.JLabel lblDerechos5;
    private javax.swing.JLabel lblGithub;
    private javax.swing.JLabel lblGithub1;
    private javax.swing.JLabel lblGithub2;
    private javax.swing.JLabel lblLinkedin;
    private javax.swing.JLabel lblLinkedin1;
    private javax.swing.JLabel lblLinkedin2;
